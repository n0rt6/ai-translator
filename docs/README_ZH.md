...
一款[开源](https://github.com/n0rt6/ai-translator)的 Raycast 扩展:自动识别输入语言并翻译——外语译成中文,中文译成英文。支持**任意 OpenAI 兼容 API**,模型完全由你选择:DeepSeek、智谱 GLM、Kimi、OpenAI、OpenRouter、本地 Ollama 实例,或任何其他可通过兼容端点访问的模型。

> **[English](https://github.com/n0rt6/ai-translator/blob/main/README.md)** · MIT License

---

## ✨ 功能特性

- [x] **自动语言检测**——无需手动选择源语言/目标语言;外语自动译成中文,中文自动译成英文(目标语言可配置)
...
3. **翻译历史**——输入 `翻译历史` 回车,可搜索、复制、删除历史记录
